...
/**
 * unmovable gameObject to draw at right side.
 */
public class BlockObjectRight extends CollidableGameObject {
     ...
     */
    public BlockObjectRight(GameView gameView, GamePlayManager gamePlayManager, Position position) {
